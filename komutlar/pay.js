...
module.exports = {
  ...
  execute: async(client, message, args, data, db) => {
    ...
    if (message.mentions.users.cache.size < 1 || isNaN(amount) || amount < 1) return message.channel.send(`Geçersiz Kullanım! | Bir Kullanıcıyı Etiketlemelisiniz Ve Geçerli Miktarda Coin Girmelisiniz!`)
